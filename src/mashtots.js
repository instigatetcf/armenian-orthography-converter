...
(function (window, exports) {
    ...
    errorCorrectionSovietToMashtotsInTheWord = [
        ...
        ['փորձէ', 'փորձե'], ['ուերականգն', 'վերականգն'],
        ['(դրու|տան|ստիպ|սպան|պարզ|կռու|որոշ|կոյս)է(մ|ն|ր)', '$1ե$2'], ['(' + start + ')կտրոն', '$1կտրօն'], ['ւարուհի', 'վարուհի'],
        ['կօքս', 'կոքս'],
        ['(' + start + ')կ(լին|հաղորդ|մնա|վնաս|փորձ|տեսն|տեղադր|տան|վերա|ստիպ|ստան|սպան|սկս|սիր|պաշտպան|պարզ|պահ)',
            '$1կը-$2'],
        ['(' + start + ')կ(ուղարկ|ուզէ|որոշ)', '$1կ\'$2'],
    ...
    errorCorrectionMashtotsToSovietInTheWord = [
        ...
        ['յեղկոմ', 'հեղկոմ'], ['յափր', 'հափր'], ['յարուց', 'հարուց'],
