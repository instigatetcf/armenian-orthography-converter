...
(function (window, exports) {
    ...
    errorCorrectionSovietToMashtotsInTheWord = [
        ...
        ['կոնսէր', 'կոնսեր'], ['կոնգրէսմէն', 'կոնգրէսմեն'],
        ['(դրու|տան|ստիպ|սպան|պարզ|կռու|որոշ|կոյս)է(մ|ն|ր)', '$1ե$2'], ['(' + start + ')կտրոն', '$1կտրօն'],
        ['(' + start + ')կ(հ|յ|լին|մնա|վնաս|փորձ|տեսն|տեղադր|տան|վերա|ստիպ|ստան|սպան|սկս|սիր|պաշտպան|պարզ|պահ|' +
            'շարունակ|նստ|նայ|մեռն|ձեռնարկ|խօս|կա|դնի|բեր|զբաղ|դադար|դարձ|գա)', '$1կը $2'],
        ['(' + start + ')կ(ուղարկ|ուզէ|որոշ|ուզեն|ունե|իրական|ըսէ|ընձեռ|ընդուն|ըլն|ըսէ|երթա|ելն)', '$1կ\'$2']
    ];
