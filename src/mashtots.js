...
(function (window, exports) {
    ...
    errorCorrectionSovietToMashtotsInTheWord = [
        ...
        ['զւունի', 'զովունի'], ['զինաւար', 'զինավար'], ['զէնդերէն', 'զենդերէն'],
        ['(դրու|տան|ստիպ|սպան|պարզ|կռու|որոշ|կոյս|ճանաչ|հասն|յանձնու|կատար|լուծ|զբաղու|գտնու|' +
            'գործ|կարծ|կարլ|ւորու|աշխատ|անցկացու|խայտ)է(մ|ն|ր)', '$1ե$2'],
        ['(' + start + ')կտրոն', '$1կտրօն'],
    ...
    wordsParts = [
        ...
        ['թոզոտվել', 'թօզոտուել'], ['թեյ', 'թէյ'], ['զոռ', 'զօռ'], ['զբոս', 'զբօս']
    ];
